        ...
        <div>
            ...
            {currentUser && (
              <HistoryDisplay
                ...
                // FIX: Explicitly cast the item.output to CodeExplanation
                // This resolves the TypeScript error by telling the compiler that
                // the `item.output` property is of the expected type.
                renderItem={(item) => renderExplanation(item.output as CodeExplanation)}
